...
@section('title','Riwayat Pengisian Terakhir')
@section('content')
<div class="section-header">
    <div class="section-header-back">
        <a href="{{ route('profiles.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
    </div>
    <h1>Riwayat Pengisian Terakhir</h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Beranda</a></div>
      <div class="breadcrumb-item"><a href="{{ route('profiles.index') }}">Profiles</a></div>
      <div class="breadcrumb-item">Riwayat Pengisian Terakhir</div>
    </div>
</div>
        ...
        <div class="col-12">
          <div class="card card-primary shadow">
            <div class="card-header">
              <h4>Kuesioner Periode {{ $period }}</h4>
            </div>
            <div class="card-body">
