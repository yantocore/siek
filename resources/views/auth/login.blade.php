        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="assets/img/logo-sieka.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <div class="d-block">
                    	<label for="password" class="control-label" tabindex="5">Password</label>
            ...
            <div class="simple-footer">
              Copyright &copy; 2022. Dipersiapkan Oleh <a href="https://yanto.my.id">Yanto</a>
            </div>
          </div>
        </div>
      </div>
